      ...
      <Col size='md-12 mb-4'>
        <Card className='p-4 mb-5'>
          ...
          <Card.Footer className='text-center p-8'>
            <Row>
              <Col>
                Click the search button to find animal sacturaries or login to
                see saved sacturaries
              </Col>
            </Row>
            <Row>
              <Col>
                <Link to='/search'>
                  <Button size='lg' className='sm'>
                    Search
                  </Button>
                </Link>{' '}
                <Link to='/signin'>
                  <Button variant='success' size='lg' className='sm'>
                    Login
                  </Button>
                </Link>
              </Col>
